      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center,
          ...
          children: [
            ...
            Text('Job Post for Electrician Engineer',style: TextStyle(fontSize: 14,fontFamily: 'Kadwa',color: black),),
            SizedBox(height: MediaQuery.of(context).size.height*0.05,),
            SvgPicture.asset('assets/images/confirmation.svg'),
            //Image.asset('assets/images/confirmation.png'),
            SizedBox(height: MediaQuery.of(context).size.height*0.03,),
            Text('Job has been Post, We have procced your appication',textAlign: TextAlign.center,
              style: TextStyle(fontFamily: 'Kadwa',fontSize: 18,fontWeight: FontWeight.w700),),
            ...
            Material(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
Navigator.push(context, MaterialPageRoute(builder: (context)=>EkInch()));
                    },
                    child: Center(
                      child: Text(
                        'Create New Job',
