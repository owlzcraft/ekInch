...
Widget servicesAndNews(String heading, String subHeading, bool isLive,
    String bottomImage, String date, String time) {
  return Container(
      ...
      children: [
        Text(
          ...
          style: GoogleFonts.kadwa(
              height: 1.4, fontSize: F14(), fontWeight: FontWeight.w400),
        ),
        isLive
            ? Row(
