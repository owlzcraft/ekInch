...
JobApplicationRequestCard(
  ...
  return Padding(
    ...
    child: GestureDetector(
      onTap: () {
        Get.to(AllApplicationListView(company: "Ultratech", title: title, location: location, salary: salary, qualification: qualification, language: language, experience: experience, time: time));
      },
      child: Stack(
        children: [
          Container(
                  ...
                  child: open
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: const Color.fromARGB(255, 159, 242, 247)),
                          child: Padding(
                            padding:
